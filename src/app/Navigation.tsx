...
export default function Navigation() {
  return (
    <div className="w-full h-24 text-slate-100 flex items-center justify-center bg-slate-900">
      <div
      ...
      >
        ...
        <div className="w-3/4 h-full text-slate-300 text-md flex gap-10 font-light items-center justify-end">
          ...
          <Link href="/blog">
            <button className="h-full w-full hover:text-blue-500">Blog</button>
          </Link>
          <Link href="/about">
            <button className="h-full w-full hover:text-blue-500">About</button>
          </Link>
          <Link
            href="/join"
